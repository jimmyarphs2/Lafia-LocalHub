-- Reject control-whitespace-only audit reasons and persist canonical reasons.

-- Fail closed if the database locale classifies known invisible characters as
-- alphanumeric or fails to recognize accented Latin letters used by customers.
do $localhub_admin_reason_contract$
declare
...
begin
  if pg_catalog.regexp_replace(
    pg_catalog.regexp_replace(
      U&'\0085\00A0\00AD\034F\061C\115F\1160\17B4\180B\200B\202A\2060\3164\FE0F\FEFF\FFA0\FFF0\+01BCA0\+01D173\+0E0001\+0E0100',
      default_ignorable_pattern,
      '',
      'g'
    ),
    '[^[:alnum:]]',
  ...
  then
    raise exception 'database Unicode classification is unsafe for audit reasons';
  end if;
end;
$localhub_admin_reason_contract$;
