...
describe("LocalHub–ORBIT bridge", () => {
  it(
    "maps the first LocalHub control-loop event without performing an external action",
    async () => {
  ...
  it(
    "uses the source event as the idempotency key and keeps the envelope immutable",
    () => {
